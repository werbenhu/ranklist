...
ok      github.com/werbenhu/skiplist    4.040s

$ go test -race
Structure sizes: SkipList is 120, Element is 48 bytes
PASS
ok      github.com/werbenhu/skiplist    24.663s

$ go test -bench=.
Structure sizes: SkipList is 120, Element is 48 bytes
goos: windows
goarch: amd64
pkg: github.com/werbenhu/skiplist
cpu: AMD Ryzen 5 5600H with Radeon Graphics
BenchmarkIncSet-12       3983136               319.2 ns/op      12479770.42 MB/s              68 B/op          2 allocs/op
BenchmarkIncGet-12       3421617               313.7 ns/op      10907933.21 MB/s               7 B/op          0 allocs/op
BenchmarkDecSet-12       5564055               253.8 ns/op      21922668.56 MB/s              68 B/op          2 allocs/op
BenchmarkDecGet-12       2745344               380.7 ns/op      7211966.97 MB/s        7 B/op          0 allocs/op
PASS
ok      github.com/werbenhu/skiplist    14.934s
```
...
If skiplist is faster than other packages with the same features, it's because it does *less* wherever possible. It locks less, it blocks less, and it traverses less data. Even with these tricks up its sleeve, it has fewer lines of code than most implementations.
